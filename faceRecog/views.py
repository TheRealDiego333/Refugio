...
from veterinaria.settings import BASE_DIR
...
def create_dataset(request):   
    ...
    while(True):
        ...
        for(x,y,w,h) in faces:
            ...
            cv2.imwrite('/home/diego/Documents/Proyecto/veterinaria/ml/dataset/' +'usuario'+'.'+str(id)+'.'+str(sampleNum)+'.jpg', gray[y:y+h,x:x+w])
...
def trainer(request):
    ...
    #Path of the samples
    path = '/home/diego/Documents/Proyecto/veterinaria/ml/dataset/'
    ...
    recognizer.save('/home/diego/Documents/Proyecto/veterinaria/ml/recognizer/trainingData.yml')
    cv2.destroyAllWindows()
    return redirect('/')
...
def detect(request):
    ...
    rec.read('/home/diego/Documents/Proyecto/veterinaria/ml/recognizer/trainingData.yml')
    getId = 0
    ...
    while(True):
        ...
        for(x,y,w,h) in faces:
            ...
            if conf<35:
                ...
                if contador == 3:
                    ...
                    cam.release()
                    cv2.destroyAllWindows()
                    request.session['form_message'] = "Rostro desconocido"
        ...
        if(cv2.waitKey(1) == ord('q')):
            ...
            cam.release()
            cv2.destroyAllWindows()
            request.session['form_message'] = "Rostro identificado"
